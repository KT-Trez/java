...
@Embeddable
@AttributeOverrides({
        @AttributeOverride(name = "R", column = @Column(name = "red", nullable = false)),
        @AttributeOverride(name = "G", column = @Column(name = "green", nullable = false)),
        @AttributeOverride(name = "B", column = @Column(name = "blue", nullable = false)),
